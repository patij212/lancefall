...
export const BESTIARY: CodexEntry[] = [
  ...
  { id: 'seeker', name: 'Seeker', cat: 'enemy', accent: '#e879f9', blurb: 'Fires a slow homing bolt that curves after you, then flies straight. Dash through it (i-frames) or juke wide — it can\'t out-turn a committed dodge.' },
  // ── special ──
